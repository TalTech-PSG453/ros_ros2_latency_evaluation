...
void DataLogger::save_logged_data(std::string filename)
{
    ...
    fRecordedSubs.open("/home/sejego/catkin_ws/src/tb_digital_twin/logged_data/subscriptions/"+filename);
    ...
    fRecordedPubs.open("/home/sejego/catkin_ws/src/tb_digital_twin/logged_data/publishers/"+filename);
