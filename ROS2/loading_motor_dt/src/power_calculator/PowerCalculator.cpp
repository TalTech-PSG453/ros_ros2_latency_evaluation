...
public:
    ...
    PowerCalculator() : Node("power_calculator")
    {
        ...
        timer_electrical_ = this->create_wall_timer(16.69ms, std::bind(&PowerCalculator::publishElectricalPower, this)); // Here frequency maybe faulty - check it
        timer_reactive_ = this->create_wall_timer(16.69ms, std::bind(&PowerCalculator::publishReactivePower, this));
